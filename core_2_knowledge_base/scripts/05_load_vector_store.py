"""Phase 5: Generate embeddings and load into ChromaDB vector store.

Uses Gemini text-embedding-004 for embeddings.
Uses local ChromaDB persistent storage (no server needed).
...
def main():
    ...
    print("=" * 60)
    print("PHASE 5: Load Vector Store (ChromaDB + Gemini Embeddings)")
    print("=" * 60)
    ...
    total = 0
    for coll_name in VectorStore.COLLECTIONS:
